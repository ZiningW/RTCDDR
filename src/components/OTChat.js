...
export default class OTChat extends Component {
  ...
  onPublish = () => {
    ...
    this.props.poseNetVideoSourced(this.state.userMediaSource);
  };
  ...
  async getOTUserMedia(){
    this.setState({
      ...
      userMediaSource: (await OT.getUserMedia())
    })
    console.log("pose media source", this.state.userMediaSource)
  }
